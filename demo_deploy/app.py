"""
app.py — SSR Results Explorer (hosted demo)

Read-only demo of the SSR results explorer, serving a bundled example run
from ./demo_data. Deployed to Streamlit Community Cloud and embedded on
milesstoddart.com.
"""
...
# ---------------------------------------------------------------------------
# Sidebar — bundled demo data
# ---------------------------------------------------------------------------

st.sidebar.title("📊 SSR Explorer")
st.sidebar.caption("Live demo — synthetic panel data from a bundled example run.")

data_dir = str(Path(__file__).resolve().parent / "demo_data")
